...
CountThreshold<-10 #makes a large difference in total n of filtered junctions
NControlsThreshold<-5 #makes virtually no difference
...
#Filter CM junctions by "uniqueness"- how many times can it be found in other CM samples?
nThreshold=3
```
