...
Using our data
```{r}
#Read in vcf- ASEReadCounter --> allelic depth/basic filtering OR pre-filtered variants, based on exome
#AseReadCounter
...
#Pre-filtered, based on exome
  mySNVs<-read.csv("D:/UKy/MergingRNASeq/MergedRuns_vcf.gz/NonCM_GOIFiltered/MERGED_FinalFilteredVariants_PercentCoverageExome_AllCMVariants.csv",row.names="X")
...
#run MBASES
ASEresults_1s_haplotypesKnown <- runMBASED(
ASESummarizedExperiment=myOwnSample,
 isPhased=TRUE,
 numSim=10^3,
 BPPARAM = SerialParam()
 )
