...
#CM: read in filepaths, calculate allelic depth + add geneID info + coverage filters  
AllAllelicExpression<- lapply(filepaths, AllelicExpressionFromASEReadCounter, genes, 15,2,2,3)
```
